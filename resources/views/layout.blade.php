...
{{--change the http to https in this once i switch it to HTTPS!!!--}}
...
<head>
    ...
    <meta name="keywords" lang="en-us"
          content="check engine light free diagnostic,
              free places to get a check engine light diagnostic,
              ...
              check engine light free diagnosis,
              free check engine light service,
              check check engine light for free,
              check engine light service,
              free diagnostic check engine light,
              who does check engine light for free,
              who does free check engine light diagnostics,
              auto parts shops,
              free engine check light,
              free engine code check,
              free check engine scan,
              free check engine diagnosis,
              check engine service,
              free check engine light scan,
              free check engine light diagnostic,
              check engine light check free,
              free engine light diagnosis,
              free car diagnostic check,
              free diagnostic car,
              free engine diagnostics,
              free auto diagnostic check,
              where to get a free car diagnostic,
              free check engine,
              check engine free,
              diagnostic check engine light,
              check engine light free national locations,
              check engine light free national chains,
              check engine light free chains,
              free check engine service,
              free diagnostic on car,
              auto free diagnostic,
              where can i get a free car diagnostic,
              where can i get a free car diagnosis,
              united states of america auto parts stores,
              usa auto parts stores,
              us auto parts stores,
              check engine free us auto part stores,
              us auto part stores that offer check engine services free"/>
...
<script>(function(d, s, id) {
        ...
        //js._https = (window.location.protocol == "https:");
        if (d.getElementById(id)) return;
        js = d.createElement(s); js.id = id;
        js.src = "//connect.facebook.net/en_US/sdk.js#xfbml=1&appId=590306801102510&version=v2.0";
...
<div data-role="page" data-theme="b" id="mappins">
    <div data-role="header" style="overflow:hidden;" data-theme="b"  data-tap-toggle="false">
        <img class='img-responsive' alt='nearbynativecasinos.com' src='../checkenginelaravel/public/images/checkenginelogoyay3.png'/>
...
<div data-role="page" data-theme="b" id="about">
    <div data-role="header" data-tap-toggle="false" data-theme="b">
        <img class='img-responsive' alt='checkenginefree.com' src='../checkenginelaravel/public/images/checkenginelogoyay3.png'/>
        <div data-role="navbar">
            <ul class="nav-trickery">
    ...
    <div data-role="footer" style="overflow:hidden;" data-theme="b" data-tap-toggle="false">
        <span class="credit">checkenginefree.com &copy; 2015</span>
